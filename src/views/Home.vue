...
<div >
          ...
          <div class="grid grid-cols-1 gap-5 mt-6 sm:grid-cols-2 lg:grid-cols-4">
            <span >
              <div class="p-4 transition-shadow border rounded-lg shadow-sm bg-white hover:shadow-lg">
...
<script lang="ts">
	...
	export default {
		setup() {
			const myStore = getModule(SystemModule);

			setTimeout(()=>{
				myStore.setName('jose luis');
			}, 500);

			const name = computed(()=> myStore.name);
