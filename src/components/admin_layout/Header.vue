      ...
      <div class="flex items-center justify-between p-2">
        ...
        <div class="flex items-center justify-between p-2">
            <div class="flex items-center space-x-3">
              ...
              <button class="p-2 rounded-md focus:outline-none focus:ring" v-on:click="toggleSideBar">
                <svg class="w-4 h-4 text-gray-600" :class="{'transform transition-transform -rotate-180': show}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div class="relative flex items-center space-x-3">
              ...
              <div class="items-center hidden space-x-3 md:flex">
                ...
                <div class="relative" x-data="{ isOpen: false }">
                  ...
                  <!-- Dropdown card -->
                  <div  x-show.transition.opacity="isOpen" class="absolute w-48 max-w-md mt-3 transform bg-white rounded-md shadow-lg -translate-x-3/4 min-w-max" style="display: none;">
                ...
                <div x-data="{ isOpen: false }">
                  ...
                  <!-- Dropdown -->
                  <div  @keydown.escape="isOpen = false" x-show.transition.opacity="isOpen" class="absolute mt-3 transform bg-white rounded-md shadow-lg -translate-x-3/4 min-w-max" style="display: none;">
                ...
                <div class="relative" x-data="{ isOpen: false }">
                  ...
                  <!-- Dropdown card -->
                  <div  x-show.transition.opacity="false" class="absolute w-40 max-w-sm mt-3 transform bg-white rounded-md shadow-lg -translate-x-3/4 min-w-max" style="display: none;">
                    <div class="p-4 font-medium border-b">
              ...
              <div class="relative" x-data="{ isOpen: false }">
                ...
                <!-- Dropdown card -->
                <div  x-show.transition.opacity="isOpen" class="absolute mt-3 transform -translate-x-full bg-white rounded-md shadow-lg min-w-max" style="display: none;">
